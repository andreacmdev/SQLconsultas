select 
    ...
    cli.NU_CPF_CNPJ AS CNPJ_CPF_Cliente,
    cli.DS_CLI AS nome_cliente,
    ramo.DS_RAM as ramo_atividade,
...
FROM mgpve01010 pedidos
    LEFT JOIN mgcpg01010 cond ON pedidos.NU_CPG = cond.NU_CPG
    LEFT JOIN mgcli01010 cli ON pedidos.NU_CLI = cli.NU_CLI
    LEFT JOIN mgpxt01010 pedxtit ON pedidos.NU_PVE = pedxtit.NU_PVE
    LEFT JOIN mgcta01014 tit ON pedxtit.nu_cta = tit.nu_cta
    LEFT JOIN mgram01010 ramo ON cli.NU_RAM = ramo.NU_RAM
WHERE 
