...
SELECT 
    ...
    TO_CHAR(CAST(d.data_devolucao AS DATE), 'YYYY-MM-DD') AS data_devolucao  -- Conversão para DATE antes de aplicar TO_CHAR
FROM devolucoes d
LEFT JOIN (
    SELECT 
        unidade,
...
WHERE d.data_devolucao::DATE BETWEEN '2024-01-01' AND '2024-06-30';
